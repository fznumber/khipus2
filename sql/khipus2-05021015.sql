...
--------------------------------------------------------
  ...
  CREATE TABLE EOS.COMPANIA 
   (	IDCOMPANIA BIGINT(24) NOT NULL auto_increment, 
		CODIGO VARCHAR(255),
...
CREATE TABLE EOS.DERECHOACCESO
  (
    IDFUNCIONALIDAD BIGINT(24)  NOT NULL auto_increment,
 ...
 /*ALTER TABLE EOS.DERECHOACCESO ADD CONSTRAINT DERECHOACCESO_PK PRIMARY KEY ( IDFUNCIONALIDAD, IDROL ) ;*/
  ...
  CREATE TABLE EOS.MODULO
    (
      IDMODULO BIGINT(24)  NOT NULL auto_increment,
      DESCRIPCION text ,
  ...
  CREATE TABLE EOS.ROL
    (
      IDROL BIGINT(24)  NOT NULL auto_increment,
      DESCRIPCION text ,
      NOMBRE     VARCHAR (150 ) ,
      VERSION    BIGINT(24)  ,
      IDCOMPANIA BIGINT(24) ,
  ...
  CREATE TABLE EOS.USUARIO
    (
      IDUSUARIO       BIGINT(24)  NOT NULL auto_increment ,
